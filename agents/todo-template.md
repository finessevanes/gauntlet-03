...
- [ ] Define Tauri command(s): `[command_name]`
...
- [ ] Define Rust structs (if needed) for [data]
- [ ] Session persistence logic (if needed): [what gets saved]
...
- [ ] Wire React components → Tauri commands
  - Test: Invoke command from UI, verify response
