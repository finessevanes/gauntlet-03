...
**Type:** Native desktop application (Tauri + React)
...
**Video Processing:** FFmpeg (bundled, no external dependencies)
**Build:** npm + Rust toolchain
**Platform:** macOS (primary), Windows (secondary)

### Key Dependencies
- FFmpeg: Video import, trim, export operations
- Tauri: File system, process management, window control
...
- Commit example: `feat: add video_import Tauri command with validation`
